    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="bg-white rounded-2xl shadow-lg p-8 max-w-md mx-4 text-center">
          ...
          <p className="text-sm text-gray-500">Confirmation details will be sent to your email.</p>
        </div>
      </div>
    );
  }
              ...
              <div>
                ...
                <div className="mb-8 p-6 bg-blue-50 rounded-xl">
                  ...
                  <div className="flex justify-between items-center">
                    <div>
                      <h3 className="text-lg font-medium text-gray-900">{bookingData.room_title}</h3>
                      <p className="text-blue-600 font-semibold">{bookingData.room_price} per night</p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="mt-8 p-6 bg-gray-50 rounded-xl">
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">{bookingData.room_title}</span>
                      </div>
                      <div className="flex justify-between">
              ...
              <div>
                ...
                <form onSubmit={handleSubmitBooking} className="space-y-6">
                  ...
                  <div className="p-6 bg-gray-50 rounded-xl">
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        <span className="text-gray-600">Room: {bookingData.room_title}</span>
                        <span className="font-medium">{bookingData.room_price} × {bookingData.nights} nights</span>
                      </div>
                      <div className="flex justify-between">
